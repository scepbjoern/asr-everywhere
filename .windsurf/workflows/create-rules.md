---
description: Create global rules (main-rules.md) from codebase analysis
---

# Create Global Rules

Create a main-rules.md file by analyzing the codebase (or in Greenfield projects the PRD) and extracting patterns.
...
| Windows Desktop Application | An application that can be installed on Windows |
...
### Create main-rules.md

Use the template at `.windsurf/global-rules-template.md` as a starting point.

**Output path**: `.windsurf/rules/main-rules.md`
...
1. Review the generated `main-rules.md`
...
- Keep main-rules.md focused and scannable
